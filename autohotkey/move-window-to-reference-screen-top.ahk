; Script Name: move-window-to-reference-screen-top.ahk
; Description: Executes my ifwin console utility when keyboard shortcut
;              Windows+Shift+a is pressed to quickly snap the active window to
;              the top of my second monitor / reference screen.
