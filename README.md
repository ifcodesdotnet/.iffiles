...
- The json file within the root directory of the repository corresponds to the execution context of my dotfiles management scripts. It contains the following metadata pertaining to my dotfiles:
  - Name of each dotfiles directory.
  - Directory where the contents of each dotfiles directory need to be copied to apply configuration to the host machine.
